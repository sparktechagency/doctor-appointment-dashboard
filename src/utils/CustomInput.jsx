    ...
    <div className="w-full relative">
      ...
      {isTextArea ? (
        <Input.TextArea
          ...
          className={`w-full border border-primary px-4 py-2 text-[16px] bg-[#D5EDFF] text-gray-700 rounded-lg focus:border-primary ${className}`}
        ...
        <Input
          ...
          className={`w-full border border-primary px-4 py-2 text-[16px] bg-[#D5EDFF] text-gray-700 rounded-lg focus:border-primary ${className}`} // Apply focus color
